...
<script lang="ts">
    import { Comment, Comments, Header, Link, Text, Date, Actions, Image, Metadata, Form, Content, Field, Button, Textarea, Icon } from "../svelte-fomantic-ui.svelte";
...
<Examples
    ...
    <!-- Comment -->
    <!------------------------------------------------------------------------------------------------------------------------------------------------>
    <Example title = "Comment" code = {Code.comment}>
