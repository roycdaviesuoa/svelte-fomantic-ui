...
<script lang="ts">
    import { behavior, update, Modal, Button } from "../svelte-fomantic-ui.svelte";
...
<Examples
    ...
    <Example title = "XXXX" code = {Code.XXXX}>
        ...
        <Button ui on:click={()=>{behavior("example1", "show")}}>Activate</Button>

        <Modal ui id="example1" settings={example1}/>
