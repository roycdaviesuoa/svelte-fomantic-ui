...
<script lang="ts">
    import { Label, Labels, Icon, Link, Image, Detail, Form, Field, Divider, Input, Grid, Column, Row, Segment, Placeholder, Paragraph, Line, Content, List, Menu} from "../svelte-fomantic-ui.svelte";
    import "./prism.css";
...
<div class="example-document">
    <h3 class="document-header">Label examples and tests</h3>
    <div class="document-description">To check these are correct, compare with standard FomanticUI, <a href="https://fomantic-ui.com/elements/label.html">here</a></div>

    <div class="example">
        <h4 class="example-header">A Label</h4>
        <Label ui>
            <Icon mail/> 23
        </Label>
...
<Label ui image>
    ...
    <div class="example">
        <h4 class="example-header">Pointing</h4>
        <Form ui fluid>
            <Field>
...
<Grid ui two column>
    ...
    <div class="example">
        <h4 class="example-header">Tag</h4>
...
<Link ui teal tag label>Featured</Link>
    ...
    <div class="example">
        <h4 class="example-header">Ribbon</h4>
        <Grid ui two column>
            <Column>
                <Segment ui raised>
...
<Grid ui celled three column>
    ...
    <div class="example">
        <h4 class="example-header">Horizontal</h4>
...
<Menu ui compact>
    ...
    <div class="example">
        <h4 class="example-header">Floating left</h4>
        <Menu ui compact>
            <Link item>
                <Icon mail/> Messages
...
<Menu ui compact>
    ...
    <div class="example">
        <h4 class="example-header">Floating aligned</h4>
        <Menu ui compact>
            <Link item>
...
<Segment ui inverted>
    ...
    <div class="example">
        <h4 class="example-header">Detail</h4>
        <Label ui>
            Dogs
            <Detail>214</Detail>
        </Label>
...
<Label ui>
    ...
    <div class="example">
        <h4 class="example-header">Icons on the right</h4>
        <Label ui right icon>
            Mail
            <Icon mail/>
        </Label>
...
<Label ui right icon>
    ...
    <div class="example">
        <h4 class="example-header">Icons no text</h4>
        <Label ui icon>
            <Icon mail/>
        </Label>
        <Label ui icon>
...
<Label ui>
    ...
    <div class="example">
        <h4 class="example-header">Disabled Link</h4>
