...
<script lang="ts">
    import { Segment, Placeholder, Header, Line, Paragraph, Icon, Button, Inline, Grid, Divider, Row, Column, Field, Input, Search, Content, Segments, Message } from "svelte-fomantic-ui";
